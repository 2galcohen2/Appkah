...
public class RecognizePlate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recognize_plate);
    ...
    private void onAnprEngineStop() {
        ...
        //Return plate number
        Intent reportActivity = new Intent(getApplicationContext(), CreateReport.class);
        Report newRep = (Report) getIntent().getSerializableExtra("newRep");
        newRep.setCarNum(plate_num);
        reportActivity.putExtra("newRep", newRep);
        startActivity(reportActivity);
    }

    private void onAnprEngineConfigtext_resultsure() {
    ...
    private void populateRecognitionResults(final AnprResult[] results, final Bitmap resultsFrame) {
        ...
        plate_num = results[0].getPlate();
        mTextResults.append( plate_num + "\r\n");
    }
}
*/
